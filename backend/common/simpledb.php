 ...
 *
 * @author Jibin <>
 * @version 1.0.0 (DD/MM/YY) Jibin - Initial version
            1.1.0 (DD/MM/YY) Lince - Filtering spcial character in insert update functions
            1.2.0 (21/03/21) Jishnu Raj - Rewritten class from its base, along with full backward
                               compatibility, better documentation, better way to debug,
                               and a recommendation to use secure functions instead of
                               possible insecure functions.
            1.3.0 (10/05/22) Neethu - change $password to $response[password] in admin_login function.
            1.4.0 (10/05/22) Roshan - change $primary_db, $password and $username values to protected from private to display profile
...
class simple_db extends SimpleDBConfig
{
    ...
    public function select_any_one777(string $table, string $condition, bool $debug_dumb = false)
